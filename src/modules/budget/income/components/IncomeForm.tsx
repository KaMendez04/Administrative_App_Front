...
import { useDepartments, useIncomeSubTypes, useIncomeTypes } from "../hooks/useIncomeCatalog";
import type { CreateIncomeDTO } from "../models/IncomeType";
import { parseCR, useMoneyInput } from "../../../../hooks/Budget/useMoneyInput";
import { useCreateIncomeEntry } from "../hooks/useIncomeMutation";
