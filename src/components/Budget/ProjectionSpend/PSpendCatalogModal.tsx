...
import { useDepartments, useSpendTypes } from "../../../hooks/Budget/projectionSpend/useSpendProjectionCatalog";
import { useCreateDepartment, useCreateSpendSubType, useCreateSpendType } from "../../../hooks/Budget/projectionSpend/useSpendProjectionMutation";
...
export default function CatalogModal({
  ...
  useEffect(() => {
    if (defaultSpendTypeId) setTypeId(defaultSpendTypeId);
  }, [defaultSpendTypeId]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
      <div className="w-full max-w-3xl rounded-2xl bg-white shadow-2xl ring-1 ring-gray-100">
        <div className="flex items-center justify-between border-b p-4 md:p-5">
          <h2 className="text-lg font-semibold text-gray-900">Creación</h2>
          <button
            onClick={onClose}
