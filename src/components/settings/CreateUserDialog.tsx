                  ...
                  return (
                    <div>
                      ...
                      <Input
                        ...
                        value={f.state.value}
                        onBlur={f.handleBlur}
                        onChange={(e) => f.handleChange(e.target.value.slice(0, USERNAME_MAX))}
                  ...
                  return (
                    <div>
                      ...
                      <Input
                        ...
                        value={f.state.value}
                        onBlur={f.handleBlur}
                        onChange={(e) => f.handleChange(e.target.value.slice(0, EMAIL_MAX))}
                        className={inputClass}
                      />
                  ...
                  return (
                    <div>
                      ...
                      <PasswordInput
                        value={f.state.value}
                        onBlur={f.handleBlur}
                        onChange={(v) => f.handleChange(v.slice(0, PASSWORD_MAX))}
              ...
              <form.Field
                ...
                validators={{
                  ...
                  onChange: ({ value, fieldApi }) => {
                    ...
                    if (value.length > PASSWORD_MAX) return "La confirmación no puede tener más de 75 caracteres."
