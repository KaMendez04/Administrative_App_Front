...
export default function LoginForm(props: LoginFormProps) {
  const { email, setEmail, password, setPassword, remember, setRemember, loading, error, handleSubmit } = props
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <div className="mt-2 flex items-center justify-between text-[15px]">
        ...
        <Link to="/forgot-password" className="text-[#324B73] hover:underline">Olvidé mi contraseña</Link>
      </div>
